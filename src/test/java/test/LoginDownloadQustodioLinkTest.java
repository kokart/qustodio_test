...
public class LoginDownloadQustodioLinkTest {		
		//Global values
		...
		public void testLoginWrongCredentials(String url,String titleToCheck, String tittleHomePage) throws InterruptedException {	
